...
cfg.actionbars = cfg.actionbars or {
    ...
    bar2 = { point="BOTTOM", relPoint="BOTTOM", x=0, y=50, layout="H", count=12 },

    -- Right bars
    bar3 = { point="RIGHT", relPoint="RIGHT", x=-10, y=0, layout="V", count=12, enabled=false },
    bar4 = { point="RIGHT", relPoint="RIGHT", x=-50, y=0, layout="V", count=12, enabled=false },
    ...
    stanceBar = { point="BOTTOM", relPoint="BOTTOM", x=0, y=90, layout="H" },
}
